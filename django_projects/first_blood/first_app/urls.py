...
from .views import (
    RegistrationUser, main_page, info_about_user, AddArticle,
    DisplayAllArticles, DisplayArticlesByUser,
    UserInfoUpdate, post_edit_view, CustomLoginView,
    CheckPinView,
)
...
urlpatterns = [
    ...
    path('blog/user/change_password/', auth_views.PasswordChangeView.as_view(
